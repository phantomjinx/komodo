...
public class StorageTypeSerializer extends TypeAdapter< RestStorageType > {
            ...
            while ( in.hasNext() ) {
                ...
                switch ( name ) {
                    case RestStorageType.NAME_LABEL:
                        ...
                        break;
                    case RestStorageType.ATTRIBUTES_LABEL:
                        RestStorageTypeAttribute[] attributes = BUILDER.fromJson(in, RestStorageTypeAttribute[].class);
                        storageType.setAttributes(attributes);
                        break;
                    default:
        ...
        public void write( final JsonWriter out, final RestStorageType value ) throws IOException {
            ...
            out.name(RestStorageType.ATTRIBUTES_LABEL);
            BUILDER.toJson(value.getAttributes().toArray(new RestStorageTypeAttribute[0]), RestStorageTypeAttribute[].class, out);
