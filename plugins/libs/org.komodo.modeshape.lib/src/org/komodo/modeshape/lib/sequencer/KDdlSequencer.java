...
/**
 * Extension of {@link DdlSequencer} that only uses the
...
public class KDdlSequencer extends DdlSequencer {
    ...
    public void initialize( NamespaceRegistry registry,
        ...
        registerNodeTypes(DdlSequencer.class.getResourceAsStream("StandardDdl.cnd"), nodeTypeManager, true);
        registerNodeTypes(DdlSequencer.class.getResourceAsStream("dialect/teiid/TeiidDdl.cnd"), nodeTypeManager, true);
    }
    ...
    public void setGrammars(String[] grammarNamesOrClasses) {
        String[] grammars = new String[] {TeiidDdlParser.ID};
        super.setGrammars(grammars);
    }
