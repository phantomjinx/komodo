...
public class DefaultDdlImporter implements DdlImporter {
    ...
    private KomodoObject prepareImport(String ddl, ImportOptions importOptions, ImportMessages importMessages) throws Exception {
         ...
         */
        Workspace wksp = WorkspaceManager.getInstance().getWorkspace(repository);
        ...
        switch(importOptions.getImportType()) {
            case MODEL:
                ...
                Model model = wksp.addModel(transaction, modelName);
            ...
            case SCHEMA:
                ...
                Schema schema = wksp.addSchema(transaction, schemaName, ddl);
                resultNode = schema;
                break;
            default:
                break;
